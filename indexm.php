...
<html>
  <head>
    ...
    <title>文件图库</title>
    <meta name="keywords" content="更多精品资源免费下载地址https://zhiyun66.github.io">
...
if(post('action')){
  ...
  // check updates
    ...
    $file = 'https://cdn.jsdelivr.net/npm/files.photo.gallery' . ($version ? '@' . $version : '') . '/img.php';
